...
// Esta versión agrega las validaciones de los campos en forma dinámica.
...
export const useForm = ( initialForm = {}, formValidations = {} ) => {
    ...
    // El siguiente state es para guardar la info de si hay un error en un campo o no. Debido a que si 
    // hay un error necesito que se redibuje el form, necesito usar un hook que maneje este state.  
    ...
    const onInputChange = ({ target }) => { // Desestructuro el target del evento que recibo
        const {name, value } = target;  // Ahora del target desestructuro el nombre y el valor del input
        setFormState({ 
            ...formState,
...
/*
 ...
 esta manera al definir useForm en un componente puedo usar directamente un objeto con los nombre de los
 campos. Así está hecho en TodoAdd.jsx
 ...
 (4)
 Devuelvo el objeto de los campos validados todo desestructurado. Cada propiedad tiene como nombte 
 el nombre del    campo + Valid y como valor null si no tiene error o el texto si tiene error.
